...
public class image {
    ...
    public static final void combineCodeAndPicToFile(String backPicPath, BufferedImage code/*String fillPicPath*/) {
        ...
        BufferedImage small = ImageIO.read(new File(fillPicPath));*/
            ...
            ImageIO.write(big, "png", new File("C:/Users/huawei/Desktop/combinePic.jpg"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) throws IOException, WriterException {
        BufferedImage code = createImage("{\"deviceId\":1}", null, false);
        combineCodeAndPicToFile("C:/Users/huawei/Desktop/addNews.png", code);
//        combineCodeAndPicToBase64("C:/Users/huawei/Desktop/addNews.png", code);
    }
}
