...
import com.iris.domain.associate.AuthorAndBlog;
import com.iris.domain.Blog;
import com.iris.domain.associate.BlogAndAuthor;
import com.iris.domain.associate.BlogAndComment;
import com.iris.mapper.BlogMapper;
import com.iris.mapper.BlogMapperExt;
...
public class MyBatisTest {
    ...
    public void testStatement() throws IOException {
        ...
        try {
            Blog blog = (Blog) session.selectOne("com.iris.mapper.BlogMapper.selectBlogById", 1);
